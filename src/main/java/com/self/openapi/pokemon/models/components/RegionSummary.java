...
public class RegionSummary {
    ...
    public RegionSummary withName(String name) {
        Utils.checkNotNull(name, "name");
        this.name = name;
        return this;
    }

    public RegionSummary withUrl(String url) {
        Utils.checkNotNull(url, "url");
        this.url = url;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        RegionSummary other = (RegionSummary) o;
        return 
    ...
    public String toString() {
        return Utils.toString(RegionSummary.class,
                "name", name,
                "url", url);
    }
