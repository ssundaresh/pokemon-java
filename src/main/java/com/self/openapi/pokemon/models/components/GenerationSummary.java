...
public class GenerationSummary {
    ...
    public GenerationSummary withName(String name) {
        Utils.checkNotNull(name, "name");
        this.name = name;
        return this;
    }

    public GenerationSummary withUrl(String url) {
        Utils.checkNotNull(url, "url");
        this.url = url;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GenerationSummary other = (GenerationSummary) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GenerationSummary.class,
                "name", name,
                "url", url);
    }
